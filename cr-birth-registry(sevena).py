...
--         repadd.intperpoid_port AS PostofficeId,
        ...
        --PERMANENT ADDRESS OUTSIDE KERALA
        NULL as premaAddOutKldistrictid,
        NULL as premaAddOutKlname,
        NULL as premaAddOutKlnameInLcl,
        NULL as premaAddOutKlhouseNoName	,
        NULL as premaAddOutKlhouseNoNameInLcl,	
        NULL as premaAddOutKllocalityName,	
        NULL as premaAddOutKllocalityNameInLcl,	
        NULL as premaAddOutKlpinCode	,
        NULL as premaAddOutKlpostOfficeName,	
        NULL as premaAddOutKlstreetName,	
        NULL as premaAddOutKlstreetNameInLcl,	
        NULL as premaAddOutKltehsilName,	
        NULL as premaAddOutKltownOrVillage,	
        NULL as premaAddOutKlvillageName,
...
--         repadd.intperstate AS permanentStateId,
    ...
    batch = []
    print(f"Migration starts...: {result_dict}")
    ...
    for row in cursor:
        (multiple, childCount, id, registrationNumber, certificateNumber, applicationNumber, registrationDate,
         ...
         pstAddOutIndiatownOrVillage,

         premaAddOutKldistrictid, premaAddOutKlname, premaAddOutKlnameInLcl,
         premaAddOutKlhouseNoName,
        ...
        birth_registry = {
            ...
            "childDetails": {
                ...
                "birthPlaceVehicle": {
                    ...
                    "vehicleType": {
                        "id": str(vehicleTypeId),
                        "name": vechilename,
                        "nameInLcl": vechilenameInLcl
                    },
                    "village": {
                        "id": str(vechilevillageid),
            ...
            "addressDetails": {
                ...
                "permanentAddressOutsideKerala": {
                    "district": {
                        "id": str(premaAddOutKldistrictid),
                        "name": premaAddOutKlname,
                        "nameInLcl": premaAddOutKlnameInLcl
                    },
                    "houseNoName": premaAddOutKlhouseNoName,
                    "houseNoNameInLcl": premaAddOutKlhouseNoNameInLcl,
                    "localityName": premaAddOutKllocalityName,
                    "localityNameInLcl": premaAddOutKllocalityNameInLcl,
                    "pinCode": premaAddOutKlpinCode,
                    "postOfficeName": premaAddOutKlpostOfficeName,
                    "streetName": premaAddOutKlstreetName,
                    "streetNameInLcl": premaAddOutKlstreetNameInLcl,
                    "tehsilName": premaAddOutKltehsilName,
                    "townOrVillage": premaAddOutKltownOrVillage,
                    "villageName": premaAddOutKlvillageName
                },
                "permanentCountry": {
                ...
                "presentAddressInsideKerala": {
                    "district": {
                        "id": str(presentAddressInsideKeralaDistrictid),
                        "name": preAddInKlname,
                    ...
                    "taluk": {
                        "id": str(pstAddinKltalukid),
                        "name": pstAddinKlname,
                        "nameInLcl": pstAddinKlnameInLcl
                    },
                    "village": {
                        "id": str(pstAddinKlvillageid),
                        "name": pstAddinKlname,
                        "nameInLcl": pstAddinKlnameInLcl
                    },
                    "ward": {
                        "id": str(pstAddinKlwardid),
                        "name": pstAddinKlname,
                        "nameInLcl": pstAddinKlnameInLcl
                    }
                },
